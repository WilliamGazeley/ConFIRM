...
from peft import get_peft_config, get_peft_model, TaskType, PromptEncoderConfig
import torch
...
parser = argparse.ArgumentParser(description=\
    "llama 2 p-tuning tuning script for ConFIRM using peft" \
    )
# Required arguments
...
parser.add_argument('--encoder_hidden_size', type=int, required=True,
...
def main(**kwargs):
    ...
    peft_config = PromptEncoderConfig(
        ...
        num_virtual_tokens=kwargs["num_virtual_tokens"],
